...
```{r}
writexl::write_xlsx(func_res, path = "my_exported_funcres.xlsx")
```
...
A very good collection of material is linked in the material included in the `iSEEdemo` pckage - see https://isee.github.io/iSEEdemo/articles/iSEEdemo.html
